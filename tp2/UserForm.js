  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{marginBottom:10}}>
        ...
        <TextInput selectedValue={role} onValueChange={setRole} style={{color:'#fff', backgroundColor:'#222'}}>
          <TextInput.Item label="User" value="user" />
          <TextInput.Item label="Admin" value="admin" />
        </TextInput>
      </View>
